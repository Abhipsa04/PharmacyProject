  ...
  <tr align="justify">
    <td valign="top" width="220px">
      ...
      <h1>Pharmaceutist</h1>
    	...
    	<% 
%>
<table><h1>All Orders Marked As Delivered.</h1><%
	...
	//System.out.println(userName);
      	...
      	try {
			...
			PreparedStatement ps=con.prepareStatement("update custorder set status='delivered' where DISTRIBUTOR_NAME=? and status='confirmed'");
			//ps.setString(1,username);
			ps.setString(1,userName);
			int count=ps.executeUpdate();
			 PreparedStatement ps1=con.prepareStatement("select * from custorder where DISTRIBUTOR_NAME=? and status='delivered'");
			//ps.setString(1,username);
