...
<table width="960" border="0" cellspacing="10" cellpadding="0" align="center">
	<tr align="justify">
		...
		<td valign="top">
			...
			<form name=F1 onSubmit="return dil(this)" action="distributerproductlist.jsp">
		...
		<td valign="top"><img src="images/hioxindia-pharmacy_10.jpg"
			alt="" border="0" />
			<h1>Drug Store</h1>
		...
		<tr align="justify">
			...
			<td width="760" valign="top">
				...
				<p>This is free Pharmaceutical Company Template for your online
					...
					pharmacy, drug store, medical store then this template would be the
					best one. This free pharmaceutical company template is designed by
					professional designers to make your task much easier to customize
					it.</p> <br />
